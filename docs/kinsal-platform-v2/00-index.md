...
|-------|------|--------|--------|
| **1 — Resources foundation** | [01-phase1-overview.md](./01-phase1-overview.md) | 🟡 In Progress | — |
| 1a. Database | [01a-db-resources-rooms.md](./01a-db-resources-rooms.md) | 🟡 In Progress | — |
| 1b. API | [01b-api-resources-booking.md](./01b-api-resources-booking.md) | 🟡 In Progress | — |
| 1c. Student grid UI | [01c-ui-student-grid.md](./01c-ui-student-grid.md) | 🟡 In Progress | — |
| 1d. Instructor Settings UI | [01d-ui-instructor-settings.md](./01d-ui-instructor-settings.md) | 🟡 In Progress | — |
| 2. Editable schedule | [02-schedule.md](./02-schedule.md) | Pending | — |
...
Phase 1 **deployed to Supabase** (migration + edge functions). Remaining: upload `index.html` to GitHub Pages and hard-refresh Pixiset embed.

## Architectural Decisions Made

- **Resources replace wheels:** stable `id` in keys; `category` for wheel / hand_build / clay_prep / glaze
- **Table-level booking:** server assigns `spot_index`; UI shows "X of Y seats"
- **Rooms:** editable labels only; max 10 rooms, 20 resources
